    ...
    <div className="space-y-2">
      ...
      {value && (
        <div className="relative inline-block mt-2">
          <div className="w-32 h-24 rounded-lg border border-gray-200 overflow-hidden bg-gray-50">
            <img
              src={value}
              alt="Preview"
